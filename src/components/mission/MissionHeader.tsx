...
export const MissionHeader: React.FC = () => {
  return (
    <div className="text-center mb-16">
      ...
      <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-health-dark to-health-primary bg-clip-text text-transparent mb-6">What We Do</h3>
