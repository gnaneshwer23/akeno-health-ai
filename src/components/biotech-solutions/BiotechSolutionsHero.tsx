    ...
    <section className="py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-block px-4 py-1.5 mb-6 rounded-full bg-health-primary/10 text-health-primary font-medium">
          Biotech & Pharmaceutical Solutions
        </div>
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-health-dark mb-6 leading-tight">
          ...
          <span className="inline-block">Solutions for Biotech & Pharma</span>
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
          At Akeno Health AI, we empower biotech and pharmaceutical companies by leveraging AI-driven drug discovery, biomarker-based clinical trials, synthetic biology, and immune therapy innovations.
        </p>
...
export default BiotechSolutionsHero;
