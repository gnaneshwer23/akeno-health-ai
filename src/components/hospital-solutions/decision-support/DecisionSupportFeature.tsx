...
interface DecisionSupportFeatureProps {
  icon: React.ReactNode;
  title: string;
  description: string;
}

const DecisionSupportFeature = ({ icon, title, description }: DecisionSupportFeatureProps) => (
...
export default DecisionSupportFeature;
