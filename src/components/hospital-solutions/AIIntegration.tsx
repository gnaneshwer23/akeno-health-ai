...
import IntegrationFeaturesList from './integration/IntegrationFeaturesList';
import HospitalDashboard from './integration/HospitalDashboard';
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-white/80 p-8 rounded-xl shadow-lg border border-health-primary/20 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-medium bg-gradient-to-r from-health-dark to-health-primary bg-clip-text text-transparent mb-6">
              AI-Powered Hospital & Clinic Integration
            </h2>
            
            <p className="text-lg text-muted-foreground mb-8">
              Akeno Health integrates directly with hospital systems, EHRs, and clinical workflows, offering scalable AI-powered infrastructure to enhance every aspect of patient care.
            </p>
            ...
            <div className="p-6 bg-gradient-to-br from-health-primary/10 to-health-accent/10 border border-health-primary/10 rounded-lg shadow-inner mt-8">
              ...
              <p className="text-muted-foreground">Optimize hospital operations, reduce inefficiencies, and enhance the quality of patient care with seamless AI integration.</p>
            </div>
          </div>
