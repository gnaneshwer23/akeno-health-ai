...
const Hero: React.FC = () => {
  ...
  const features = [
    ...
    "Personalized Medicine with Multi-Omics Integration",
    "Continuous AI Monitoring & Adaptive Therapy",
    "Digital Twin Technology for Predictive Modelling",
    "AI-Driven Insights & Preventive Strategies"
  ];
