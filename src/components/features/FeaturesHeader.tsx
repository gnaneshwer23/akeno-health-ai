...
export const FeaturesHeader: React.FC = () => {
  return (
    <div className="text-center mb-16">
      ...
      <h2 className="text-3xl md:text-5xl font-bold text-health-dark mb-6">Our Patient-Centered Approach</h2>
      ...
      <p className="text-lg text-health-dark/70 max-w-3xl mx-auto">
        Akeno Health integrates your health data with advanced AI to deliver personalized insights, early detection, and improved health outcomes.
      </p>
    </div>
  );
};
