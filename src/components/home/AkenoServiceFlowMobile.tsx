    ...
    <div className="w-full py-8 px-4">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-health-primary/10 text-health-primary font-medium text-xs mb-3">
          ...
          <span>EMPOWERING HEALTHCARE</span>
        </div>
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-health-primary/10">
        <div className="space-y-3 mb-4">
          ...
          <DataSource 
            ...
            icon={<Dna size={20} className="text-health-secondary" />} 
        ...
        <div className="space-y-3 mb-4">
          ...
          <Stakeholder 
            ...
            icon={<Stethoscope size={20} className="text-health-primary" />}
            delay={0.6}
          />
          <Stakeholder 
            title="Hospital Systems" 
            icon={<Users size={20} className="text-health-secondary" />}
            delay={0.7}
          />
          <Stakeholder 
            title="Patients" 
            icon={<UserRound size={20} className="text-health-accent" />}
            delay={0.8}
          />
        </div>
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-health-primary">Outcomes</h3>
          <div className="flex flex-wrap gap-2">
            <Outcome title="Precision Diagnostics" delay={1.0} />
            <Outcome title="Resource Optimization" delay={1.1} />
            <Outcome title="Personalized Care" delay={1.2} />
          </div>
        </div>
      </div>
    </div>
